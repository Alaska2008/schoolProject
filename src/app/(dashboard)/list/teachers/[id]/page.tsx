            ...
            <div className="w-full xl:w-2/3">
                <div className="flex flex-col lg:flex-row gap-4">
                    ...
                    <div className="flex-1 flex gap-4 justify-between flex-wrap">
                        <div className="bg-white p-4 rounded-md flex gap-4 w-full md:w-[48%] xl:[45%] lg:w[48%]">
            ...
            <div className="w-full flex flex-col gap-4 xl:w-1/3">
                <div className="bg-white p-1 rounded-md">
                    ...
                    <div className="mt-4 flex gap-4 flex-wrap text-gray-500">
                        <Link className="p-1 rounded-md bg-lamaSkyLight" href={`/list/classes?supervisorId=${"teacher2"}`} >
                            Teacher&apos;s Classes
                        </Link>
                        <Link className="p-1 rounded-md bg-lamaPurpleLight" href={`/list/students?teacherId=${"teacher2"}`} >
                            Teacher&apos;s Students
                        </Link>
                        <Link className="p-1 rounded-md bg-lamaYellowLight" href={`/list/lessons?teacherId=${"teacher2"}`} >
                            Teacher&apos;s Lessons
                        </Link>
                        <Link className="p-1 rounded-md bg-pink-50" href={`/list/exams?supervisorId=${"teacher2"}`} >
                            Teacher&apos;s Exams
                        </Link>
                        <Link className="p-1 rounded-md bg-lamaSkyLight" href={`/list/assignments?supervisorId=${"teacher2"}`} >
